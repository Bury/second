...
<script>
    ...
    export default {
        ...
        methods: {
        	//列表
        	guestList(){
        		let startTime = Date.parse(this.$data.value4[0])
        		let endTime = Date.parse(this.$data.value4[1]);
        		this.$data.requestParameters.store_time_start = (startTime || "")/1000;        		
				this.$data.requestParameters.store_time_end = (endTime || "")/1000;
