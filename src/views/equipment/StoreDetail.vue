<template>
	<div class="store-detail-page">
		...
		<!-- 列表 -->
		<el-table :data="tableData" border style="width:971px;text-align:center;">
	    	<el-table-column fixed prop="deviceId" label="设备编号" width="120"></el-table-column>
	    	<el-table-column fixed prop="deviceType" label="设备种类" width="120"></el-table-column>
