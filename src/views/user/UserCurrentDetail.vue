<template>
  <div style="width: 100%;background: #fff;padding: 3rem 0 1.5rem;">
    <div class="personal-page">
      <div class="top-box">
        <h3>个人资料</h3>
        <div class="editBtn">
          <el-button @click="fnSetting()">个人设置</el-button>
          <el-button @click="fnChangeTel()">修改手机</el-button>
          <el-button @click="fnPasswordEdit()">修改密码</el-button>
        </div>
      </div>
      ...
      <el-dialog title="修改密码" center :visible.sync="dialogFormVisible" style="min-width:800px;" :before-close="dialogClose">
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button @click="fnPasswordEditSubmitForm('passwordEditForm')">确 定</el-button>
        </div>
      </el-dialog>
      <!--修改手机号 -->
      <el-dialog title="修改手机号" center :visible.sync="dialogFormVisibleTel" :before-close="dialogCloseTel" style="min-width:800px;">
        <el-form :model="telForm" :rules="rules" ref="telForm" label-width="100px" class="demo-ruleForm">
          <el-row>
            <el-form-item label="新手机号：" prop="phone">
              ...
              <el-button type="primary" plain style="margin-left: 1rem;" @click="code"  :class="{disabled: !this.canClick}">{{getClickName}}</el-button>
            </el-form-item>
          </el-row>
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button @click="submitFromTel('telForm')">确 定</el-button>
        </div>
      </el-dialog>
      ...
      <el-dialog title="个人设置" center :visible.sync="settingVisible" style="min-width:800px;" :before-close="dialogCloseSetting">
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button @click="fnSettingSubmit()">确 定</el-button>
        </div>
      </el-dialog>
